...
Resources should be added to "resources" folder and obtaining any resources from the folder could be done by using "RESOURCES_PATH" macro to get a path to "resources" root.
